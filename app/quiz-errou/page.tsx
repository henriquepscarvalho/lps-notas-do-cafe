  ...
  return (
    <>
      ...
      <main style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "4rem 24px", textAlign: "center", background: "#2C1810", position: "relative" }}>
        <div style={{ position: "absolute", top: "30%", left: "50%", transform: "translate(-50%, -50%)", width: "min(500px, 100vw)", height: 500, background: `radial-gradient(circle, rgba(139,69,19,0.30), transparent 70%)`, pointerEvents: "none" }} />
