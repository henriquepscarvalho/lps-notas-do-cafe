...
<header class="hero"><div class="wrap">
  ...
  <h1>1.710 leitores que buscam a xícara perfeita</h1>
  <p class="sub">Da fazenda à xícara: tudo sobre café especial.</p>
</div></header>

<section><div class="wrap">
  <div class="stats"><div class="stat"><div class="v">1.710</div><div class="l">Leitores ativos</div><div class="n">base verificada</div></div><div class="stat"><div class="v">~7.475</div><div class="l">Impressões / mês</div><div class="n">aberturas de e-mail</div></div><div class="stat"><div class="v">~456</div><div class="l">Cliques / mês</div><div class="n">em links</div></div><div class="stat"><div class="v">~26</div><div class="l">Edições / mês</div><div class="n">últimos 30 dias</div></div><div class="stat"><div class="v">23%</div><div class="l">Taxa de abertura</div><div class="n">média mensal</div></div><div class="stat"><div class="v">41%</div><div class="l">Renda R$5k+</div><div class="n">perfil de inscrição</div></div></div>
</div></section>

<section><div class="wrap">
  <div class="sec-tag">I · Alcance mensal</div>
  <h2 class="sec-title">O que sua marca alcança em um mês.</h2>
  <p class="sec-intro">Cerca de 26 edições no último mês. Não é alcance vazio: a audiência abre, lê e clica.</p>
  <div class="grid2">
    <div class="chart">
      <div class="ct">Funil de um mês · 26 edições</div>
      <div class="funnel">
        <div class="frow"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 8h20"/></svg></div><div class="fbar" style="width:100%"><span class="fv">~7.475</span><span class="fl">Impressões (aberturas)</span></div></div>
        <div class="frow"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><div class="fbar" style="width:62%"><span class="fv">~456</span><span class="fl">Cliques em links</span></div></div>
        <div class="fnote">1 patrocínio principal por edição, sem dividir a atenção com outras marcas.</div>
      </div>
    </div>
    <div class="leadcards">
      <div class="lc"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><div><h4>Lê para agir</h4><p>~7.475 aberturas por mês de gente que abre buscando o próximo passo, não distração.</p></div></div>
      ...
      <div class="lc"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><div><h4>Audiência que age</h4><p>Cerca de ~456 cliques por mês nos links das edições.</p></div></div>
    </div>
  </div>
</div></section>
...
<div class="wrap"><p class="src">Dados atualizados em 01/07/2026.</p></div>
