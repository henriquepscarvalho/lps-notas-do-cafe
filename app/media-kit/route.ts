...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .adprev{display:grid;grid-template-columns:.9fr 1.1fr;gap:40px;align-items:center;margin:34px 0 6px}
  .mock{background:var(--card);border:1px solid var(--line);border-radius:16px;padding:20px 18px;display:flex;flex-direction:column;gap:11px;max-width:370px}
  .mock .mtop{display:flex;align-items:center;gap:9px;padding-bottom:11px;border-bottom:1px solid var(--line)}
  .mock .mtop img{width:22px;height:22px;border-radius:50%;object-fit:contain}
  .mock .mtop span{font-family:var(--label);font-size:10.5px;letter-spacing:.14em;text-transform:uppercase}
  .msk{height:8px;border-radius:99px;background:var(--track)}
  .w100{width:100%}.w95{width:95%}.w90{width:90%}.w85{width:85%}.w75{width:75%}.w60{width:60%}
  .mspon,.mad{position:relative;border:1px solid var(--accent);border-radius:12px;background:color-mix(in srgb,var(--accent) 9%,transparent)}
  .mtag{position:absolute;left:-11px;top:-11px;width:22px;height:22px;border-radius:7px;background:var(--accent);color:var(--btn-fg);font-family:var(--label);font-weight:700;font-size:12px;display:grid;place-items:center}
  .mspon{padding:10px 14px;font-size:12px;color:var(--muted)}
  .mspon b{color:var(--text);font-weight:600}
  .mad{padding:14px;display:flex;flex-direction:column;gap:9px}
  .mimg{aspect-ratio:16/9;border-radius:9px;background:var(--track);display:grid;place-items:center;font-family:var(--label);font-size:10.5px;letter-spacing:.14em;text-transform:uppercase;color:var(--muted)}
  .mcta{align-self:flex-start;font-size:12px;font-weight:600;color:var(--accent);text-decoration:underline;text-underline-offset:3px}
  .mfoot{font-size:11.5px;color:var(--faint);text-align:center;padding-top:3px}
  .lc .ic.num{font-family:var(--label);font-weight:700;font-size:15px}
  ...
  @media (max-width:860px){
    ...
    .grid2,.incgrid,.adprev{grid-template-columns:1fr;gap:30px}
    .mock{max-width:none}
...
<header class="hero"><div class="wrap">
  ...
  <h1>2.387 leitores que buscam a xícara perfeita</h1>
  <p class="sub">Da fazenda à xícara: tudo sobre café especial.</p>
</div></header>

<section><div class="wrap">
  <div class="stats"><div class="stat"><div class="v">2.387</div><div class="l">Leitores ativos</div><div class="n">base verificada</div></div><div class="stat"><div class="v">~14 mil</div><div class="l">Impressões / mês</div><div class="n">aberturas de e-mail</div></div><div class="stat"><div class="v">~493</div><div class="l">Cliques / mês</div><div class="n">em links</div></div><div class="stat"><div class="v">~29</div><div class="l">Edições / mês</div><div class="n">últimos 30 dias</div></div><div class="stat"><div class="v">21,4%</div><div class="l">Taxa de abertura</div><div class="n">média mensal</div></div><div class="stat"><div class="v">37%</div><div class="l">Renda R$5k+</div><div class="n">perfil de inscrição</div></div></div>
</div></section>

<section><div class="wrap">
  <div class="sec-tag">I · Alcance mensal</div>
  <h2 class="sec-title">O que sua marca alcança em um mês.</h2>
  <p class="sec-intro">Cerca de 29 edições no último mês. Não é alcance vazio: a audiência abre, lê e clica.</p>
  <div class="grid2">
    <div class="chart">
      <div class="ct">Funil de um mês · 29 edições</div>
      <div class="funnel">
        <div class="frow"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 8h20"/></svg></div><div class="fbar" style="width:100%"><span class="fv">~14 mil</span><span class="fl">Impressões (aberturas)</span></div></div>
        <div class="frow"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><div class="fbar" style="width:62%"><span class="fv">~493</span><span class="fl">Cliques em links</span></div></div>
        <div class="fnote">1 patrocínio principal por edição, sem dividir a atenção com outras marcas.</div>
      </div>
    </div>
    <div class="leadcards">
      <div class="lc"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><div><h4>Lê para agir</h4><p>~14 mil aberturas por mês de gente que abre buscando o próximo passo, não distração.</p></div></div>
      ...
      <div class="lc"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><div><h4>Audiência que age</h4><p>Cerca de ~493 cliques por mês nos links das edições.</p></div></div>
    </div>
  </div>
</div></section>
...
<section><div class="wrap">
  ...
  <p class="sec-intro">37% dos leitores ganham R$5.000 ou mais por mês. Gente que investe em ferramentas, cursos e serviços do setor.</p>
  <div class="incgrid">
    <div class="bars"><div class="bar"><span class="k">R$ 10 mil ou mais</span><span class="track"><span class="fill prem" style="width:6%"></span></span><span class="p">2%</span></div><div class="bar"><span class="k">R$ 5 mil a 10 mil</span><span class="track"><span class="fill prem" style="width:100%"></span></span><span class="p">36%</span></div><div class="bar"><span class="k">R$ 2 mil a 5 mil</span><span class="track"><span class="fill" style="width:83%"></span></span><span class="p">30%</span></div><div class="bar"><span class="k">Até R$ 2 mil</span><span class="track"><span class="fill" style="width:92%"></span></span><span class="p">33%</span></div></div>
    <div class="callout"><div class="big">37%</div><div class="cl">ganham R$ 5 mil ou mais por mês</div><div class="cn">e 2% passam de R$ 10 mil</div></div>
  </div>
</div></section>
...
<section><div class="wrap">
  <div class="sec-tag">IV · O patrocínio</div>
  <h2 class="sec-title">Como sua marca aparece.</h2>
  <p class="sec-intro">Patrocínio nativo, escrito na voz da newsletter. Sua marca abre a edição e assina o anúncio ao final, antes das recomendações e do voto do leitor.</p>
  <div class="adprev">
    <div class="mock">
      <div class="mtop"><img src="data:image/webp;base64," alt=""><span>Notas do Café</span></div>
      <div class="mspon"><span class="mtag">1</span>Apresentado por <b>sua marca</b></div>
      <div class="msk w100"></div><div class="msk w90"></div><div class="msk w95"></div><div class="msk w75"></div><div class="msk w60"></div>
      <div class="mad"><span class="mtag">2</span><div class="mimg">Imagem 16:9</div><div class="msk w95"></div><div class="msk w85"></div><span class="mcta">Link do patrocinador</span></div>
      <div class="mfoot">Recomendações · voto do leitor · rodapé</div>
    </div>
    <div class="leadcards">
      <div class="lc"><div class="ic num">1</div><div><h4>Aviso no topo</h4><p>Sua logo abre a edição em "Apresentado por". O leitor sabe da sua marca desde a primeira dobra.</p></div></div>
      <div class="lc"><div class="ic num">2</div><div><h4>O anúncio</h4><p>Imagem 16:9 + até 75 palavras na voz da newsletter, ao final da edição, antes das recomendações e do voto.</p></div></div>
      <div class="lc"><div class="ic num">→</div><div><h4>O clique</h4><p>O link leva pra onde você quiser: site, oferta, página de cadastro. Cliques reportados ao final.</p></div></div>
      <div class="lc"><div class="ic num">★</div><div><h4>Primeiro lugar na edição</h4><p>Sua marca abre a edição, antes de qualquer outro conteúdo. Os anúncios da rede beehiiv, quando saem, ficam no meio e no fim da edição.</p></div></div>
      <div class="lc"><div class="ic num">@</div><div><h4>E-mail + web</h4><p>O patrocínio aparece no e-mail e na versão web da edição, que segue no ar depois do envio.</p></div></div>
    </div>
  </div>
</div></section>

<section><div class="wrap">
  <div class="sec-tag">V · Valores</div>
  <h2 class="sec-title">Um patrocínio, três maneiras de contratar.</h2>
  <p class="sec-intro">Toda opção inclui o patrocínio completo: logo no topo, imagem 16:9, até 75 palavras + link, primeiro lugar na edição, no e-mail e na web. O que muda é o volume de edições e o desconto.</p>
  <div class="formats">
    <div class="fcard"><div class="ft">Avulso</div><h4>Edição Avulsa</h4><p>Uma edição com o patrocínio completo. Pra campanha pontual ou teste da audiência.</p><ul><li>1 edição</li><li>Patrocínio completo incluso</li></ul><div class="price"><b>R$ 150</b> · por edição</div></div>
    <div class="fcard"><div class="ft">Pacote</div><h4>Pacote Semanal</h4><p>Sete edições seguidas: presença diária por uma semana inteira.</p><ul><li>7 edições seguidas</li><li>−10% · sai R$ 136/edição</li></ul><div class="price"><b>R$ 950</b> · pacote de 7 edições</div></div>
    <div class="fcard"><div class="ft">Pacote</div><h4>Pacote Mensal</h4><p>Quinze edições no mês, dia sim, dia não: presença sustentada sem cansar a lista.</p><ul><li>15 edições, dia sim, dia não</li><li>−20% · sai R$ 120/edição</li></ul><div class="price"><b>R$ 1.800</b> · pacote de 15 edições</div></div>
  </div>
</div></section>

<section><div class="wrap">
  <div class="sec-tag">VI · Como funciona</div>
  <h2 class="sec-title">Do briefing ao relatório, em três passos.</h2>
  <div class="steps">
    <div class="step"><div class="n">1</div><h4>Reserva</h4><p>Você escolhe o pacote e a data. Confirmamos o slot disponível.</p></div>
    <div class="step"><div class="n">2</div><h4>Materiais</h4><p>Você envia o texto (até 75 palavras) com os links, a imagem 16:9 e sua logo.</p></div>
    <div class="step"><div class="n">3</div><h4>No ar + relatório</h4><p>O anúncio sai nas edições contratadas. Em até 3 dias úteis após a última publicação, você recebe um relatório completo.</p></div>
  </div>
</div></section>
...
<div class="wrap"><p class="src">Dados atualizados em 25/09/2026.</p></div>

<script>(function(){try{var U="https://ecmveymyzdqiehvtqxms.supabase.co",K="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVjbXZleW15emRxaWVodnRxeG1zIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk3MTA0MTAsImV4cCI6MjA4NTI4NjQxMH0.Po6pTYlWVwBpPn1PsKhwF4zYj5XMva9n9alLHskuqbE",S="notas-do-cafe";var q=new URLSearchParams(location.search);var ip=q.get("internal");if(ip==="1")localStorage.setItem("vdn_internal","1");if(ip==="0")localStorage.removeItem("vdn_internal");var interno=localStorage.getItem("vdn_internal")==="1";var ref="";try{ref=document.referrer?new URL(document.referrer).host:""}catch(e){}var med=(q.get("utm_medium")||"").toLowerCase(),usrc=(q.get("utm_source")||"").toLowerCase(),src=(q.get("src")||"").toLowerCase();var origem=(src==="edicao"||med==="newsletter"||usrc.indexOf("beehiiv")>=0||/^q\\./.test(ref)||ref.indexOf("beehiiv")>=0)?"edicao":((!ref&&!med&&!usrc&&!src)?"direto":"outro");var j=(q.get("j")||"").slice(0,60);try{if(!j)j=sessionStorage.getItem("vdn_journey")||"";if(!j){j=(crypto&&crypto.randomUUID)?crypto.randomUUID():"j_"+Math.random().toString(36).slice(2)+Date.now().toString(36)}sessionStorage.setItem("vdn_journey",j)}catch(e){if(!j)j=null}function send(ev){try{fetch(U+"/rest/v1/lp_page_views",{method:"POST",keepalive:true,headers:{apikey:K,Authorization:"Bearer "+K,"Content-Type":"application/json",Prefer:"return=minimal"},body:JSON.stringify({slug:S,funnel_step:"media-kit",event_type:ev,source:origem,journey_id:j,path:location.pathname,referrer:ref||null,user_agent:navigator.userAgent,is_internal:interno})}).catch(function(){})}catch(e){}}send("apareceu");document.addEventListener("click",function(e){var a=e.target&&e.target.closest?e.target.closest("a.btn"):null;if(a)send("converteu")},true);}catch(e){}})();</script>
</body>
</html>
`;
