...
<header class="hero"><div class="wrap">
  ...
  <h1>2.452 leitores que buscam a xícara perfeita</h1>
  <p class="sub">Da fazenda à xícara: tudo sobre café especial.</p>
</div></header>

<section><div class="wrap">
  <div class="stats"><div class="stat"><div class="v">2.452</div><div class="l">Leitores ativos</div><div class="n">base verificada</div></div><div class="stat"><div class="v">~14 mil</div><div class="l">Impressões / mês</div><div class="n">aberturas de e-mail</div></div><div class="stat"><div class="v">~458</div><div class="l">Cliques / mês</div><div class="n">em links</div></div><div class="stat"><div class="v">~28</div><div class="l">Edições / mês</div><div class="n">últimos 30 dias</div></div><div class="stat"><div class="v">21,4%</div><div class="l">Taxa de abertura</div><div class="n">média mensal</div></div><div class="stat"><div class="v">37%</div><div class="l">Renda R$5k+</div><div class="n">perfil de inscrição</div></div></div>
</div></section>

<section><div class="wrap">
  <div class="sec-tag">I · Alcance mensal</div>
  <h2 class="sec-title">O que sua marca alcança em um mês.</h2>
  <p class="sec-intro">Cerca de 28 edições no último mês. Não é alcance vazio: a audiência abre, lê e clica.</p>
  <div class="grid2">
    <div class="chart">
      <div class="ct">Funil de um mês · 28 edições</div>
      <div class="funnel">
    ...
    <div class="leadcards">
      ...
      <div class="lc"><div class="ic"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><div><h4>Audiência que age</h4><p>Cerca de ~458 cliques por mês nos links das edições.</p></div></div>
    </div>
  </div>
</div></section>
...
<section><div class="wrap">
  ...
  <div class="adprev">
    ...
    <div class="leadcards">
      ...
      <div class="lc"><div class="ic num">★</div><div><h4>Anunciante único</h4><p>Só o seu anúncio sai na edição. Sua marca não concorre com nenhum outro anunciante.</p></div></div>
...
<section><div class="wrap">
  ...
  <p class="sec-intro">Toda opção inclui o patrocínio completo: logo no topo, imagem 16:9, até 75 palavras + link, anunciante único, no e-mail e na web. O que muda é o volume de edições e o desconto.</p>
  <div class="formats">
...
<div class="wrap"><p class="src">Dados atualizados em 21/09/2026.</p></div>
