...
// Passo "Leia enquanto espera" abre a ULTIMA edicao pelo redirect leia.<dominio>
// (newsletter_live_link, repontado 9x/dia): edicao com anuncio da Ad Network, onde o
// arquivo so listava posts. ?src=wizard loga o clique como prefix 'wizard' no wa_click,
// fora da leitura do WhatsApp (HC 24/09/26, wiz/26).
const ULTIMA = "https://leia.notasdocafe.com.br/?src=wizard";
