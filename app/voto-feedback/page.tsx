...
export default function VotoFeedback() {
  ...
  return (
    <>
      <PageBeacon slug="notas-do-cafe" step="voto-feedback" />
      ...
      >
        ...
        >
          O que deu{" "}
          <em style={{ fontStyle: "italic", color: "var(--accent)" }}>errado</em>?
        </h1>
          ...
          {sent ? (
            <>
              ...
              <p style={{ fontSize: "0.9375rem", color: "var(--text-secondary)", lineHeight: 1.7 }}>
                Obrigado pela franqueza. É assim que a gente acerta o ponto do café.
              </p>
            </>
          ) : (
            <>
