    ...
    <>
      ...
      <main className="ob-page">
        ...
        <p className="ob-texto">
          O mesmo link chega no seu email em alguns minutos, com o passo a passo.
          Entre no app com o email desta compra: é ele que destranca seus guias.
        </p>
        ...
        <p className="ob-nota">
          O email não apareceu? Confira spam e promoções. O botão acima já abre o app
...
.kicker{font-family:var(--mono);font-size:11px;font-weight:500;letter-spacing:.24em;text-transform:uppercase;color:var(--bright)}
        ...
        .ob-selo{width:52px;height:52px;margin:0 auto 1.3rem;border-radius:50%;background:rgba(226,120,44,.12);border:1px solid var(--bright);color:var(--bright);font-size:24px;font-weight:700;display:flex;align-items:center;justify-content:center}
        ...
        .ob-abrir{display:block;max-width:340px;margin:0 auto 1.6rem;padding:16px 22px;border-radius:12px;background:var(--bright);color:#140408;font-weight:800;font-size:17px;letter-spacing:-.01em;box-shadow:0 18px 44px rgba(226,120,44,.25);transition:filter .15s ease,transform .15s ease}
        .ob-abrir:hover{filter:brightness(1.08);transform:translateY(-1px)}
        .ob-inst{text-align:left;max-width:420px;margin:0 auto 1.4rem;padding:16px 18px;border:1px solid var(--hair);border-radius:12px;background:var(--bg-deep)}
        ...
        .bib{text-align:left;margin:1.8rem 0 .4rem;padding:22px 22px 24px;border:1px solid var(--bright);border-radius:14px;background:rgba(226,120,44,.12)}
        ...
        .bbtn{width:100%;padding:15px 18px;border:0;border-radius:11px;background:var(--bright);color:#140408;font-family:var(--sans,inherit);font-size:15.5px;font-weight:800;letter-spacing:-.01em;cursor:pointer;transition:filter .15s ease}
